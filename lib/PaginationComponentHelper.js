 ...
 * @param orderBy
 */
exports.updateUrlParmas = ({ page, perPage, orderBy, paginationParameterMapping = {
    page: "page",
    perPage: "perPage",
    orderBy: "orderBy"
} }) => {
    if (history.pushState) {
        let url = `${window.location.protocol}//${window.location.host}${window.location.pathname}?${paginationParameterMapping.page}=${page}&${paginationParameterMapping.perPage}=${perPage}&${paginationParameterMapping.orderBy}=${orderBy}`;
